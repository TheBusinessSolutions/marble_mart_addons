...

{
    ...
    #'live_test_url': 'https://youtu.be/sJhlVkhXcak',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/pos_sales_commission/915',#'https://youtu.be/aBEq9uzE7L4',
    'description': """
...
---- ---- Point of Sale/Commissions/Sales Commissions Lines
    ...
    'depends' : ['point_of_sale', 'crm', 'pos_sale'],
