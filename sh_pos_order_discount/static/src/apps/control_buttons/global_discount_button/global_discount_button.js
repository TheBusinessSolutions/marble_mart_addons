...
import { GlobalDiscountPopupWidget } from "@sh_pos_order_discount/apps/popups/global_discount_popup/global_discount_popup";

export class GlobalDiscountButton extends Component {
  static template = "sh_pos_order_discount.GlobalDiscountButton";
  setup() {
    this.pos = usePos();
